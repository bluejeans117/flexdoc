...
The FlexDoc dependency is pinned to `2.3.0`. During this release PR, CI installs the backend package from the same commit and boots the app to verify the integration at runtime; after `2.3.0` is published, the manifest is directly runnable as written.
