...
`prauga-flexdoc-axum` is pinned to `0.3.0`. During this release PR, CI patches crates.io resolution to `../../adapters/rust`; after `0.3.0` is published, the manifest is directly runnable as written.
