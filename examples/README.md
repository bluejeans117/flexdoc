...
| [`javascript-express`](./javascript-express) | Express + `@prauga/flexdoc-backend` `2.2.0` |
| [`javascript-fastify`](./javascript-fastify) | Fastify + `@prauga/flexdoc-backend` `2.2.0` |
| [`javascript-hono`](./javascript-hono) | Hono + `@prauga/flexdoc-backend` `2.2.0` |
| [`dotnet-aspnetcore`](./dotnet-aspnetcore) | `Prauga.FlexDoc.AspNetCore` `0.1.0` |
| [`java-spring`](./java-spring) | Spring Boot + `flexdoc-spring-boot-starter` `0.4.0` |
| [`java-quarkus`](./java-quarkus) | Quarkus/Jakarta REST + `flexdoc-jaxrs` `0.4.0` |
| [`java-micronaut`](./java-micronaut) | Micronaut + `flexdoc-jvm` `0.4.0` |
| [`java-guice`](./java-guice) | Guice/JDK HTTP + `flexdoc-jvm` `0.4.0` |
| [`kotlin-ktor`](./kotlin-ktor) | Ktor 3.5.2 + `flexdoc-jvm` `0.4.0` |
| [`python-fastapi`](./python-fastapi) | FastAPI/ASGI + `prauga-flexdoc` `0.3.0` |
| [`python-flask`](./python-flask) | Flask/WSGI + `prauga-flexdoc` `0.3.0` |
...
| [`go-net-http`](./go-net-http) | Go `net/http` adapter `v0.2.0` |
| [`go-gin`](./go-gin) | Gin over the `net/http` adapter `v0.2.0` |
| [`go-chi`](./go-chi) | Chi over the `net/http` adapter `v0.2.0` |
| [`go-echo`](./go-echo) | Echo v5 over the `net/http` adapter `v0.2.0` |
| [`go-fiber`](./go-fiber) | Fiber v3 direct `net/http` adaptation, adapter `v0.2.0` |
| [`rust-axum`](./rust-axum) | `prauga-flexdoc-axum` `0.2.0` |
| [`rust-actix`](./rust-actix) | `prauga-flexdoc-actix` `0.1.0` |
| [`elixir-phoenix`](./elixir-phoenix) | Phoenix forwarding `prauga_flexdoc` Plug `0.1.0` |
